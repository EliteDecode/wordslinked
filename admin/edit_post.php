            ...
            <div class="col-md-10 col-lg-10 col-xl-10" style='padding:0% 5%'>
                <div class="container pt5 ">
                    ...
                    <?php if (isset($_GET['id'])) {
                        ...
                        $result = selectOne('posts', ['id' => $id]);

                      
                        $description = $result['Description'];
                        $title = $result['Title'];
                        $authur = $result['Authur'];
                    ...
                    <form id='post_form' enctype="multipart/form-data" onsubmit="return false">
                        ...
                        <div class="form-group">
                            ...
                            <select name="topic" id="topic" class='form-control' style='font-weight:bold' '>
                                <option value=""></option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="publish" id="publish" class='form-control' style='font-weight:bold' value='5'>
                                <option value=""></option>

                        ...
                        <div class="col-md-6 col-lg 4 col-xl-4 col-sm-12 ">
                            <div class="bg-secondary inner_box" style='border-radius:10px;'>
                                <a href='posts.php' class='dash'>
                                    ...
                                    <h4>Total Posts : <?php $num = selectAll('posts', ['Authur' =>$user]);
                                    $res = count($num);
                                  if ($res > 0) {
                                      echo" <span>$res</span>";
                                  }else{
                        ...
                        <div class="col-md-6 col-lg 4 col-xl-4 col-sm-12 ">
                            <div class="bg-warning inner_box" style='border-radius:10px;'>
                                <a href='posts.php' class='dash'>
                                    ...
                                    <h4>Published Posts : <?php $num = selectAll('posts', ['Publish' => 'yes', 'Authur' => $user]);
                                    $res = count($num);
                                  if ($res > 0) {
                                      echo" <span>$res</span>";
                                  }else{
                        ...
                        <div class="col-md-6 col-lg 4 col-xl-4 col-sm-12 ">
                            <div class="bg-dark inner_box" style='border-radius:10px;'>
                                <a href='posts.php' class='dash'>
                                    ...
                                    <h4>Unpublished Posts : <?php $num = selectAll('posts', ['Publish' => 'no', 'Authur' => $user]);
                                    $res = count($num);
                                  if ($res > 0) {
                                      echo" <span>$res</span>";
                                  }else{

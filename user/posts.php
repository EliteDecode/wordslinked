...
$start=($page -1) * $limit;
// $posts = selectPageConditions('posts',['Authur' => $user], $start, $limit);

$rowcount = selectAll('posts', ['Authur' => $user]);
                   ...
                   unset($_SESSION['success']);
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <?php
                            $sql = "SELECT * FROM posts WHERE Authur = '$user' LIMIT $start, $limit";
                            ...
                            <tr>
                                ...
                                <td><a href="../single_post.php?post_id=<?php echo $post['id'] ?>"><button
